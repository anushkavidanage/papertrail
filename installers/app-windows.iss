...
#define MyAppName "PaperTrail"
#define MyAppVersion "windows-inno"
#define MyAppPublisher "Togaware Pty Ltd"
#define MyAppURL "https://github.com/anushkavidanage
#define MyAppExeName "papertrail.exe"
...
;
AppId={{37dc8a6b-134c-409a-bbf9-9fe8ccbd31fa}
AppName={#MyAppName}
...
OutputBaseFilename=papertrail-{#MyAppVersion}
